  ...
  return (
    ...
    >
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex min-w-0 items-center gap-2">
                <p className="line-clamp-1 max-w-[200px] flex-1 truncate text-sm text-muted sm:max-w-none">
                  {stock.name}
                </p>
                {stock.isETF ? (
                  <span className="hidden shrink-0 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-cyan-200 whitespace-nowrap sm:inline-flex">
      ...
      <div className="mt-4 min-h-[4.25rem]">
        {!stock.isETF ? <ValuationBadge ticker={stock.ticker} /> : null}
      </div>
